...
Sensor_write_DMP(dev_addr, reg_addr, data_size, p_data)
#define i2c_read(dev_addr, reg_addr, data_size, p_data) \
Sensor_Read_DMP(dev_addr, reg_addr, data_size, p_data)
...
const struct test_s test = {
    .gyro_sens      = 32768/500,
    .accel_sens     = 32768/4,  //FSR = +-4G =  LSB/G
    .reg_rate_div   = 1,    /* 500Hz. */
